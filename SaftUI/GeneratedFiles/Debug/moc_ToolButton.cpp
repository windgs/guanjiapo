...
static const char qt_meta_stringdata_ToolButton[] = {
    "ToolButton\0\0signal_parent(void*)\0"
    "slot_pressed()\0"
};
...
int ToolButton::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: signal_parent((*reinterpret_cast< void*(*)>(_a[1]))); break;
        case 1: slot_pressed(); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void ToolButton::signal_parent(void * _t1)
{
