...
**
** Created: Thu Mar 29 15:49:06 2012
...
const QMetaObject TitleBar::staticMetaObject = {
    { &CBaseTitleBar::staticMetaObject, qt_meta_stringdata_TitleBar,
...
void *TitleBar::qt_metacast(const char *_clname)
{
    ...
    return CBaseTitleBar::qt_metacast(_clname);
}

int TitleBar::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = CBaseTitleBar::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
